<?php
	...
	if(!isset($_GET['btn']))
	{
		...
		$query = "SELECT * FROM tbl_dosen WHERE user='$user'";
	...
	else
	{
		...
		$query = "DELETE FROM tbl_dosen WHERE user=?";
		...
		$stmt -> close();
		$db -> close();
		echo '<script>alert("Anda berhasil menghapus data dosen"); document.location="../index.php?p=dosen"</script>';
	}
...
<div class="row">
	<div class="col-xs-12">
		<section class="content">	
			<div class="box">
				<form action="dosen/hapus.php" method="get" accept-charset="utf-8">
