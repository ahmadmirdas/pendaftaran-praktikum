<?php
	...
	if(isset($_GET['btn'])){
		...
		$res = $db -> query("SELECT * FROM tbl_kalab WHERE user='$user'");
		$row = $res -> num_rows;
		if($row == 0){
			$query="INSERT INTO tbl_kalab(user,nama,fakultas,jurusan) VALUES (?,?,?,?)";
			...
			?><script language="javascript">alert("Anda telah berhasil menambah data ketua lab"); document.location='../index.php?p=kalab'</script><?php
		}
		else
		{
...
<div class="content-wrapper">
    ...
    <h1> Ketua LAB</h1>
	<ol class="breadcrumb">
        <li><i class="fa fa-book"></i> Ketua LAB</li>
        <li>Tambah</li>
    </ol>
</section>
<div class="row">
	<form  method="get" class="form-horizontal" action="kalab/tambah.php" novalidate="novalidate">
		...
		<div class="form-group">
			<label class="control-label col-lg-2">Nama Ketua Lab</label>
			<div class="col-lg-10">
