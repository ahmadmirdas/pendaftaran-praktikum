<?php
	include("koneksi.php");
	$query="SELECT COUNT(idmahasiswa) FROM tbl_mahasiswa";
	...
	$query="SELECT * FROM tbl_mahasiswa $w";
	...
	$result = $db -> query("SELECT * FROM tbl_mahasiswa $w ORDER BY user DESC LIMIT $mulai,$batas");
?>
<div class="content-wrapper">
	<section class="content-header">
    <h1>Tabel Mahasiswa</h1>
	<ol class="breadcrumb">
        <li><i class="fa fa-book"></i> Tabel Mahasiswa</li>
    </ol>
</section>
<div class="row">
	<div class="col-xs-12">
		...
		<table class="table table-hover">
			...
			?>
				<tr>
					...
					echo "<td>";
					echo "
						<a href='?p=mahasiswa&a=ubah&id=".$row['idmahasiswa']."'><input type='button' class='btn btn-primary btn-flat hapuso' title='hapus' value='Ubah'/></a>
						<a href='?p=mahasiswa&a=hapus&id=".$row['idmahasiswa']."'><input type='button' class='btn btn-danger btn-flat hapuso' title='hapus' value='Hapus'/></a>
					";
					echo "</td>";
					?>
				</tr>
		...
		<div style="float:left; padding-left: 15px; padding-bottom: 15px; ">
			<a href="?p=mahasiswa&a=tambah" class="btn btn-default"><i class="fa fa-plus"></i> Tambah</a>
		</div>
	</div>
</div>	
</div>